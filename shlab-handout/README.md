...
2020-3-17 夜 这里是荒废了一个假期的as...c9还没看一半你敢信...但是有一说一，学系统课的时候回看了这里，发觉了自己遗留了一个问题就是子进程在停止后收到sigcont之后sh不会修改状态...当然ref也有这个问题，不知道自己当时是发现了没管还是怎么回事...现在尝试修正下这个问题，想了想还是去mysh修正了（
